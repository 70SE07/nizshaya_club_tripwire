...
export const bonuses: readonly Bonus[] = [
  ...
  },
  {
    ...
    desc: "Раз в месяц — живой созвон с Владом и командой. Приходишь со своей задачей, разбираем её прямо на звонке: какой агент применить, где ошибка, как масштабировать.",
