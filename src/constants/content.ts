...
export const programItems: readonly ProgramItem[] = [
  ...
  },
  {
    ...
    desc: "Раз в месяц — живой созвон с Владом и командой. Приходишь со своей конкретной задачей: какой агент подойдёт, где ошибка в воркфлоу, как масштабировать. Работа с твоим бизнесом, а не общий вебинар.",
    premium: true,
  },
]
...
export const resultsMetrics: readonly ResultMetric[] = [
  { value: "30 дней",  desc: "до первого рабочего AI-агента" },
...
export const topicsHighlights: readonly TopicHighlight[] = [
  { tag: "Хайп",         title: "OpenClaw",                        desc: "Собираем AI-агента, который работает за тебя: в браузере, пишет код и выполняет задачи" },
  { tag: "Кейс",         title: "Контент-завод",                   desc: "Конвейер: идея → текст → визуал → пост. Рилсы, сторис, Telegram, сайт" },
